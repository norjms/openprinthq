<script>
  // Timelapse gallery. Rendered as a tab under the Cameras page.
...
<div class="tlhead">
  <p class="muted">Print timelapses across your fleet.</p>
...
<style>
  .tlhead { display: flex; justify-content: space-between; align-items: center; margin-bottom: 1rem; gap: 1rem; }
  .tlhead p { margin: 0; }
